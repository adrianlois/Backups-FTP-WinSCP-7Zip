...
[System.Windows.MessageBox]::Show("Passwords generadas correctamente: `n`n$PathFicherosPasswd\passwd-7z `n$PathFicherosPasswd\passwd-ftp `n$PathFicherosPasswd\passwd-email","Passwords path")